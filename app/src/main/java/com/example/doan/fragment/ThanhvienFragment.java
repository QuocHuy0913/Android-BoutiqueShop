...
public class ThanhvienFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_thanhvien, container, false);
        context = getContext();
        listView = mView.findViewById(R.id.lv_khac);
        listData = context.getResources().getStringArray(R.array.listview_khac);
